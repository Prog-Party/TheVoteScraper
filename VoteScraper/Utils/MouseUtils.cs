...
namespace VoteScraper.Utils
{
    public static class MouseUtils
    {
        ...
        public static void MoveToScreenCoordinate(int x, int y)
        {
            ...
            MoveTo(Convert.ToInt32(outputX/ scaling), Convert.ToInt32(outputY/ scaling));
        }
